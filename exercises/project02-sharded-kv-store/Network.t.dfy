// The network model; see the big note below for how this differs from previous
// chapters.
...
module Network {
  ...
  predicate Next(v: Variables, v': Variables, msgOps: MessageOps)
  {
    ...
    //
    // This network model differs from previous chapters. It is a magical
    // network that prevents the host from sending a duplicate message until the
    // first copy is delivered! A little unrealistic, but it'll make your proof
    // a little easier. Read the following comment & conjunct.
    //
    //////////////////////////////////////////////////////////////////////////////
